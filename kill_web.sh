...
#       argbash kill_web.sh -o kill_web.sh
...
exec 2>&1
# We are, in general, OK if any of these steps fail
# set -e
...
$CONTAINER_BIN stop --time=30 lojban_mediawiki_web${test}${live}
$CONTAINER_BIN kill lojban_mediawiki_web${test}${live}
$CONTAINER_BIN rm lojban_mediawiki_web${test}${live}
