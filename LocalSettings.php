...
# file, not there.
#
# Further documen for configuration settings may be found at:
...
$wgServer           = "https://mw.lojban.org";
$wgCanonicalServer  = "https://mw.lojban.org";
...
$wgLogo             = "$wgScriptPath/extensions/wiki.png";
...
$wgEmergencyContact = "webmaster@lojban.org";
$wgPasswordSender   = "webmaster@lojban.org";
...
#GENERAL PATCHES
//$wgAllowUserJs = true;//allows WikEd for all users, probably useless for wikEd since it's already enabled from Common.js
$wgCompressRevisions=true;//compress the database
$wgMaxArticleSize=10000;//CLL and ELG are large texts. We need them on on a single page
//require_once "$IP/extensions/NativeSvgHandler/NativeSvgHandler.php";
//$wgParserCacheType = CACHE_NONE;
$wgExternalLinkTarget = '_blank';//in order to open external links in a new window / tab.
$wgDefaultUserOptions['watchdefault'] = 1;

#GUI PAGE ELEMENTS
$wgFavicon = "/extensions/LojbanFavicon.ico";
...
$wgCapitalLinkOverrides [828] = true;
...
//$wgVectorFeatures['collapsiblenav']['global'] = false; //Allow users to enable CollapsibleNav in their preferences.
//$wgVectorFeatures['collapsiblenav']['user'] = true;
//$wgVectorFeatures['collapsibletabs']['global'] = true;
...
#CACHE.PERFOMANCE
$wgUseFileCache = false;//advise: better to set to false otherwise mobilefrontend is not reliablw
$wgFileCacheDirectory = "$IP/cache";
$wgShowIPinHeader = false;
$wgEnableSidebarCache=true;
$wgUseGzip = true;
$wgDisableCounters = true;//Note: If you’re using caching, keeping counters on will not be of use anyway because in most cases the requested page will delivered to the users from cache and database update will not take place.
//$wgMiserMode = true; //better to keep it false
...
// require_once("$IP/extensions/SimpleTable/SimpleTable.php");//only version 1.2 (not later!!!) works
//enableSemantics('mw.lojban.org');
//include_once( "$IP/extensions/SemanticForms/SemanticForms.php" );
require_once "$IP/extensions/Scribunto/Scribunto.php";//Necessary for Infobox templates from Wikipedia
...
# Robin's server alias
///combat alias mw.lojban.org that made you think you loggined from Robin's server
$wgUsePrivateIPs = true;
$wgSquidServersNoPurge = array( '173.13.139.233', '192.168.123.132', '173.13.139.235' );
///end combat mw.lojban.org



# UPLOADING
$wgUseSharedUploads = true; //trying to allow images from Wikimedia (instantcommons)
$wgAllowJavaUploads = true; // allows uploading if "This file did not pass file verification"
$wgAllowExternalImages = true;
$wgAllowImageMoving = true;
$wgUseImageMagick = true;
$wgImageMagickConvertCommand = "/usr/bin/convert";
$wgImageMagickTempDir = '/srv/mediawiki/cache';
...
$wgAllowCopyUploads = true; //////	EXTREMELY IMPORTNAT FOR UTL UPLOADING
$wgVerifyMimeType = false;
$wgCheckFileExtensions = false;
$wgStrictFileExtensions = false; // lets allow all extensions
$wgFileExtensions[] = array( 'webp','sip', 'png', 'gif', 'jpg', 'jpeg', 'bmp', 'svg','pdf','djvu','djv','doc','mp3','swf','chm','diff','docx', 'ttf' );
$wgFileBlacklist = array();
$wgMimeTypeBlacklist= array();
$wgDisableUploadScriptChecks = true;
$wgEnableUploads= true;
$wgGenerateThumbnailOnParse = true;//if false you will break thumbs
...
# FORUM
// DISABLED PER https://github.com/lojban/lmw/issues/1
//annotating. Try to emulate Google Docs commenting here using various extensions:
...
//$wgGroupPermissions['*']['wikiforum-moderator'] = false;
//$wgGroupPermissions['*']['wikiforum-admin'] = false;
//$wgGroupPermissions['user']['wikiforum-moderator'] = true;
...
##Flow
/*
 * If index rebuilds fail, uncomment this:
 *
...
// $wgWebChatServer  = 'irc.freenode.net';
// Channel to connect to.
// $wgWebChatChannel = '#jbosnu,#ckule,#lojban';
...
##TogetherJS 
//require_once("$IP/extensions/TogetherJS/TogetherJS.php");//was not easily localizable
...
# $wgVisualEditorNamespaces = array( NS_MAIN, NS_TALK, NS_USER, NS_USER_TALK, NS_IMAGE, NS_CATEGORY);
...
# $wgVisualEditorParsoidURL = 'http://localhost:9999';
...
# PAGE MANAGEMENT
ini_set( 'max_input_vars', 3000);//for ReplaceText
...
//$wgGroupPermissions['massedit']['masseditregex'] = true; // Create 'massedit' group where members can use Special:MassEditRegex without being sysops
//require_once("$IP/extensions/DeleteOldRevisions2/DeleteOldRevisions2.php");//security issues with this extension
...
//require_once("$IP/extensions/PageAttachment/SetupExtension.php");//Enable it back when it starts to support localisation


#WIDGETS
//$wgRawHtml = true; // very dangerous! please don't add the content unless it's of utter importance
...
$wgGoogleAdSenseClient = 'ca-pub-1161714373457356';
$wgGoogleAdSenseSlot = '7612993623';
$wgGoogleAdSenseID = 'First for LMW';
...
//$wgGroupPermissions['*']['edit'] = false;//must be disabled by  HideVariousTabsFromUnauthorizedUsers extension
$wgGroupPermissions['user']['edit'] = true;
$wgGroupPermissions['sysop']['edit'] = true;
$wgGroupPermissions['*']['create'] = false;
$wgGroupPermissions['user']['create'] = true;
$wgGroupPermissions['sysop']['create'] = true;
##confirm account:
require_once "$IP/extensions/ConfirmAccount/ConfirmAccount.php";
$wgGroupPermissions['user']['createaccount'] = true;
$wgConfirmAccountContact = 'llg-members@lojban.org';                        
$wgMakeUserPageFromBio = false;
$wgAutoWelcomeNewUsers = false;
$wgConfirmAccountRequestFormItems = array(
        'UserName'        => array( 'enabled' => true ),
        'RealName'        => array( 'enabled' => false ),
        'Biography'       => array( 'enabled' => false, 'minWords' => 3 ),
...
##Extension:Facebook. a fork
/*require_once "$IP/extensions/facebook-mediawiki/Facebook/Facebook.php";
$wgFbAppId  = '***REMOVED***';
$wgFbSecret = '***REMOVED***';
$wgFbNamespace      = 'mivitke';*/

##Extension:Twitter
/*include_once("$IP/extensions/TwitterLogin/TwitterLogin.php");
$wgConsumerKey = '***REMOVED***';
$wgConsumerSecret = '***REMOVED***';*/




#Notify of changes
//require_once("$IP/extensions/scripts/ircnotify.php");
# require_once("$IP/extensions/TweetANew/TweetANew.php");
# $wgTweetANewTwitter['ConsumerKey'] = '***REMOVED***';
# $wgTweetANewTwitter['ConsumerSecret'] = '***REMOVED***';
# $wgTweetANewTwitter['AccessToken'] = '***REMOVED***';
# $wgTweetANewTwitter['AccessTokenSecret'] = '***REMOVED***';
...
# 	'Enable' => true, // Only applies if $wgTweetANewTweet['New'] = false or $wgTweetANewTweet['Edit'] = false
# 	'Checked' => true, // Only applies if $wgTweetANewEditpage['Enable'] = true
# );

#GOOGLE ANALYTICS
/*require_once "$IP/extensions/googleAnalytics/googleAnalytics.php";
// Replace xxxxxxx-x with YOUR GoogleAnalytics UA number
$wgGoogleAnalyticsAccount = "UA-45171210-1"; 
// Optional Variables (both default to true)
$wgGoogleAnalyticsIgnoreSysops = true;
$wgGoogleAnalyticsIgnoreBots = true;
//$wgGoogleAnalyticsIgnoreUsers=true;//only for modified extension
...
require_once "$IP/extensions/UniversalAnalyticsIntegration/UniversalAnalyticsIntegration.php";
...
// Do NOT include web analytics code in any pages displayed to sysops (exclude sysops from web analytics).
$wgGoogleAnalyticsIgnoreSysops = true;
// Do NOT include web analytics code in any pages displayed to bots (exclude bots from web analytics).
$wgGoogleAnalyticsIgnoreBots = true;
// Do NOT include web analytics code in any pages displayed to any logged in users (exclude all users from web analytics).
$wgGoogleAnalyticsIgnoreAllUsers = false;
...
#$wgGoogleTagManagerContainerID = "GTM-MTCB68";
...
$wgLoginLanguageSelector=true;//must be important for saving the deteced language while tregistering. not tested
$wgULSGeoService = true;
$wgULSEnable =true;
$wgULSAnonCanChangeLanguage = true;
$wgULSPosition = 'none';

//for autotranslating sidebar elements. I'd suggest simply using Mediaiwki: namespace pages instead.
/*$wgTblePageTranslation = true;
ranslateCC['wiki-sidebar'] = 'addSidebarMessageGroup';
...
//!MediaWikiQuizzer::setupNamespace(104); // 104 - ????????? ?????? ???????????? ????
#Poll/Voting
...
# EmbedVideo
#old version: require_once( "$IP/extensions/EmbedVideo/EmbedVideo.php" ); 
#disabled due to too much client side BS: wfLoadExtension( 'EmbedVideo' );

# NON SORTED, disabled
//require_once( "$IP/extensions/FileSystemListing/FileSystemListing.php" );
//require_once("$IP/extensions/DirList/DirList.php");//disabled. Crashes Parsoid!!!
